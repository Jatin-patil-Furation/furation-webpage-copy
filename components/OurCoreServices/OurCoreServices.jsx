...
const OurCoreServicesSection = () => {
  ...
  return (
    <div className="w-[90%] my-[5.25rem] relative">
      <div className="w-full mb-7 sticky top-14 z-10 bg-black">
        <h1 className="text-center pt-7 text-3xl sm:text-4xl md:text-5xl lg:text-6xl md:mt-28 lg:mt-5 font-bold mb-4">
          Our Core Services
        </h1>
      ...
      <div className=" relative flex flex-wrap md:flex-nowrap  w-full my-14  gap-3">
        <div className="self-start md:sticky top-48 left-0 flex  flex-col gap-5 w-full md:w-[50%] ">
        ...
        <div className="relative w-full md:w-[49%]">
          ...
          <div className="absolute w-full h-[10%] text-white bottom-0 "></div>
          {/* shadow-inner  z-[100]  bg-gradient-to-t from-black */}
        </div>
      </div>
    </div>
  );
